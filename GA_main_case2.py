...
for z in range(30):
    ...
    for x in range(num_iteration):
        ...
        for t in range(len(total_chromosomes)):
            ...
            total_chromosomes[t].target_value= 1* total_chromosomes[t].makespan + 0*total_chromosomes[t].tardiness_num
        ...
        # 停止條件
        if chromosomes[0].target_value == 462:
            break
